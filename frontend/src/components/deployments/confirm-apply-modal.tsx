...
export function ConfirmApplyModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-rose-500/30 bg-slate-950 shadow-2xl overflow-hidden">
        <div className="p-5 border-b border-slate-800/80 flex items-start space-x-3">
        ...
        <div className="p-5 space-y-4">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-3 text-[11px] text-slate-300 space-y-1">
            <div>
              Template: <strong className="text-slate-100">{templateName}</strong>
            </div>
            <div>
          ...
          <label className="block space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white font-mono placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500/50"
            />
          </label>
        ...
        <div className="px-5 py-4 border-t border-slate-800/80 flex items-center justify-end space-x-2 bg-slate-950/80">
          <button
            onClick={onClose}
            disabled={isPending}
