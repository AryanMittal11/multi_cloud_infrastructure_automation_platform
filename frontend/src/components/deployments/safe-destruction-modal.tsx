...
export function SafeDestructionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 select-none">
      <div className="w-full max-w-xl rounded-2xl border border-rose-500/50 bg-slate-950 p-6 sm:p-7 shadow-2xl shadow-rose-950/40 space-y-5 animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
          ...
          <div className="space-y-4">
            {!destroyDeploymentId ? (
              <div className="space-y-3 text-xs text-slate-300">
                ...
                <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2 text-[11px]">
                ...
                {activeDestroyDeployment?.status === 'PLANNING' ? (
                  ...
                  <div className="space-y-3">
                    <div className="p-3.5 rounded-xl bg-rose-950/20 border border-rose-500/30 space-y-1">
                      ...
                      <pre className="text-[11px] font-mono text-slate-300 max-h-36 overflow-y-auto whitespace-pre-wrap leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5 text-xs">
              <label className="font-bold text-slate-200">
                To confirm permanent destruction, type <code className="text-rose-400 font-bold bg-slate-900 px-1.5 py-0.5 rounded border border-rose-500/30">CONFIRM_DESTROY</code> below:
              </label>
              <input
                type="text"
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-xs text-white font-mono focus:outline-none focus:border-rose-500 transition-colors"
                autoFocus
              />
            </div>
            ...
            <div className="space-y-1.5 text-xs">
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-xl bg-slate-900 border border-slate-800 text-xs text-white focus:outline-none focus:border-slate-700"
              />
            </div>
